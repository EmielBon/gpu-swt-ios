...
public:
    ...
    static List<Vector4> ReadPixels(int x, int y, int width, int height);
    
    static Vector4 ReadPixel(int x, int y);
...
inline List<Vector4> FrameBuffer::ReadPixels(int x, int y, int width, int height)
{
    return ReadPixels<Vector4>(x, y, width, height, GL_RGBA, GL_FLOAT);
}

inline Vector4 FrameBuffer::ReadPixel(int x, int y)
{
